...
class IQOptionBroker(BaseBroker):
    ...
    def _wait_init(self):
        ...
        if self.api is None:
            return
        try:
            logger.info("Aguardando api_option_init_all...")
            ...
            while time.time() < deadline:
                ...
                if result is not None:
                    ...
                    return
                time.sleep(1)
            logger.warning("api_option_init_all timeout (25s). Continuando...")
    ...
    def connect(self):
        ...
        with _RECONNECT_LOCK:
            ...
            # Carrega o asset map inicial assim que a conexão é estabelecida
            self._wait_init()
