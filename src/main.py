...
async def security_headers(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self' data:; connect-src 'self' https:;"
    return response
...
_API_PREFIXES = ("/api/", "/auth/", "/broker/", "/admin/", "/telegram/", "/ws/", "/docs", "/openapi.json", "/redoc", "/health")
if _frontend_dir:
    import mimetypes
